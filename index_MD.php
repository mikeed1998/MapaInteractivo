            ...
            <form id="form1">
                    <div id="control_map">            
                        <map name="mexico" id="map_ID">
                            ...
                            <area id="SLP" data-id-estado="24" alt="SLP" title="SAN luis Potosi"         class="area" href="#" shape="poly" coords="<?=$coordenadas['SLP'];?>" />
                            <area id="SIN" data-id-estado="25" alt="SIN" title="Sinaloa"                 class="area" href="#" shape="poly" coords="<?=$coordenadas['SIN'];?>" />
                        ...
                        <div id='content_mapa'>            
                            <img id="map_ID" class="map" src="images/mapaBlack.png" usemap="#mexico" title="Mexico" alt="Mexico" />
			                <!-- <div id="edo" >&nbsp;</div> -->
